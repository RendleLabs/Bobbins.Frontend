...
namespace Bobbins.Frontend.Services
{
    public static class HttpClientExtensions
    {
        ...
        public static Task<HttpResponseMessage> PostJsonAsync(this HttpClient client, string uri, object obj, CancellationToken ct = default)
        {
        ...
        public static Task<HttpResponseMessage> PutJsonAsync(this HttpClient client, string uri, object obj, CancellationToken ct = default)
        {
            var json = JsonConvert.SerializeObject(obj);
            var content = new StringContent(json, Encoding.UTF8, ApplicationJson);
